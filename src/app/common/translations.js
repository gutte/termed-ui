...
.config(function($translateProvider) {
  ...
  .translations('fi', {
    ...
    resetCodes: 'Alusta koodit',
    resetCodesHelp: 'Tietueiden koodit generoidaan oletuksena tietueen numeron perusteella. Alustamalla koodit uudestaan kaikkien aineiston tietueiden koodit asetetaan oletusarvoihin.',
  ...
  .translations('en', {
    ...
    resetCodesHelp: 'Operation will reset default codes for all nodes in the graph.',
