...
.config(function($translateProvider) {
  ...
  .translations('fi', {
    ...
    deleteCodes: 'poista koodit',
    deleteCodesHelp: 'Poista aineiston tietueiden koodit.',
  ...
  .translations('en', {
    ...
    deleteCodesHelp: 'Operation will delete codes for all nodes in the graph.',
